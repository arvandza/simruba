...
@section('title', 'SIMRUBA | Data Ketersediaan Ruangan')

@section('content')
    @section('route'){{ route('rooms.available') }} @endsection
    @section('current_menu')Menu Utama @endsection
    @section('current_page')Data Ketersediaan Ruangan @endsection
    <!-- Modal Input Tanggal -->
    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="time-slots mt-3">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <a href="{{ route('roomlist.edit', $item->id) }}"
