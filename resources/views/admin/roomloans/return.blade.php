...
@section('title', 'SIMRUBA | Pengembalian Ruangan')

@section('content')
    @section('route'){{ route('loanroom.return') }} @endsection
    @section('current_menu')Menu Pengembalian @endsection
    @section('current_page')Pengembalian Ruangan @endsection
    <!-- Modal Input Tanggal -->
    <div class="row">
                            ...
                            <tbody>
                                @foreach ($room as $data => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <form action="{{ route('roomloan.return', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
