...
@section('title', 'SIMRUBA | Riwayat Ruangan')

@section('content')
    @section('route'){{ route('roomloan.history') }} @endsection
    @section('current_menu')Menu Riwayat @endsection
    @section('current_page')Riwayat Ruangan @endsection
    <!-- Modal Input Tanggal -->
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dataTableExample" class="table">
                            ...
                            <tbody>
                                @foreach ($roomHistory as $data => $item)
                                    <tr>
                                        <td>{{ $data + 1 }}</td>
                                        <td>{{ $item->user->name }}
                                        </td>
