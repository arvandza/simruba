...
@section('content')
    @section('route'){{ route('rooms.index') }} @endsection
    @section('current_menu')Menu Ruangan @endsection
    @section('current_page')Tambah Data Ruangan @endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <h4 class="card-title mb-0">Tambah Data Ruangan</h4>
                    </div>
                    <p class="text-muted mb-3 mt-3">Silahkan isi data ruangan pada form dibawah ini</p>
