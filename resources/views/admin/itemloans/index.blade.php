...
@section('title', 'SIMRUBA | Pengajuan Barang')

@section('content')
    @section('route'){{ route('itemloans.index') }} @endsection
    @section('current_menu')Menu Pengajuan @endsection
    @section('current_page')Pengajuan Barang @endsection
    <!-- Modal Input Tanggal -->
    <div class="row">
                            ...
                            <tbody>
                                @foreach ($inventory as $data => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <form action="{{ route('itemloan.action', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
