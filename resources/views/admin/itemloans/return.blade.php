...
@section('title', 'SIMRUBA | Pengembalian Barang')

@section('content')
    @section('route'){{ route('loanitem.return') }} @endsection
    @section('current_menu')Menu Pengembalian @endsection
    @section('current_page')Pengembalian Barang @endsection
    <!-- Modal Input Tanggal -->
    <div class="row">
                            ...
                            <tbody>
                                @foreach ($inventory as $data => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <form action="{{ route('itemloan.return', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
